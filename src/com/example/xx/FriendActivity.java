...
public class FriendActivity extends Activity{
	 ...
	 protected void onCreate(Bundle savedInstanceState) {
            ...
            FriendAdapter adapter = new FriendAdapter(FriendActivity.this, R.layout.letter_item, userlist);
...
//                      Toast.makeText(FriendActivity.this, user.getName(), Toast.LENGTH_SHORT).show();
                      Intent intent = new Intent(FriendActivity.this,PeoplechatroomActivity.class);
               	   	  intent.putExtra("name", name);
               	      intent.putExtra("name2", user.getName());
	 ...
	 private void initLetter(){
			 ...
			 if (friends.equals("")){
	             Toast.makeText(FriendActivity.this, "用户暂无好友！", Toast.LENGTH_SHORT).show();
			 }else{
				 String friendList[];
				 if(friends.equals("0")){
	...
	public void onClickFriendListener(View v){
		 ...
		 newFriend = newFriend.findByName(userName);
			 ...
			 if(newFriend == null){
	             Toast.makeText(FriendActivity.this, "用户不存在！", Toast.LENGTH_SHORT).show();
			 }else{
				 ...
				 if(!oldFriends.equals("")){
					 ...
					 for(String friendId : friendList){
				    	if(friendId.equals(newFriendId+"")){
				             Toast.makeText(FriendActivity.this, "用户已经是好友！", Toast.LENGTH_SHORT).show();
				             flag = 1;
				    		 break;
				    	}
				     }
             ...
             Toast.makeText(FriendActivity.this, "好友添加成功！", Toast.LENGTH_SHORT).show();
             //刷新
