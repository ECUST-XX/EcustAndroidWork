...
public class FixFriendActivity extends Activity{
	 ...
	 protected void onCreate(Bundle savedInstanceState) {
          ...
          FriendAdapter adapter = new FriendAdapter(FixFriendActivity.this, R.layout.letter_item, userlist);
          ...
          listview.setOnItemClickListener(new OnItemClickListener(){
              ...
              public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent intent = new Intent(FixFriendActivity.this,FixUserActivity.class);
	 ...
	 private void initLetter(){
			 ...
			 if (friends.equals("")){
	             Toast.makeText(FixFriendActivity.this, "用户暂无好友！", Toast.LENGTH_SHORT).show();
			 }else{
				 String friendList[];
				 if(friends.equals("0")){
	...
	public void onClickFriendListener(View v){
		 ...
		 newFriend = newFriend.findByName(userName);
			 ...
			 if(newFriend == null){
	             Toast.makeText(FixFriendActivity.this, "用户不存在！", Toast.LENGTH_SHORT).show();
			 }else{
				 ...
				 if(!oldFriends.equals("")){
					 ...
					 for(String friendId : friendList){
				    	if(friendId.equals(newFriendId+"")){
				             Toast.makeText(FixFriendActivity.this, "用户已经是好友！", Toast.LENGTH_SHORT).show();
				             flag = 1;
				    		 break;
				    	}
				     }
           ...
           Toast.makeText(FixFriendActivity.this, "好友添加成功！", Toast.LENGTH_SHORT).show();
           //刷新
